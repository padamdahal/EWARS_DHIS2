	...
	trackerCapture.directive('input', function () {
		...
		var link = function ($scope, element, attrs, ngModel) {
			...
			if(element.attr('max-date') != undefined){
				...
				var customDateField = $('<button class="nepali-calendar" style="position:relative;float:left;background:#fff;border:none;padding:0"><img src="https://cdn4.iconfinder.com/data/icons/small-n-flat/24/calendar-512.png" style="height:34px;"/></button>');
