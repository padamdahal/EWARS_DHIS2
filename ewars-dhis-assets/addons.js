	...
	trackerCapture.directive('input', function () {
		...
		var link = function ($scope, element, attrs, ngModel) {
			...
			if(element.attr('max-date') != undefined){
				...
				var customDateField = $('<span class="nepali-calendar" style="position:relative;float:left;"><img src="https://i.pinimg.com/236x/ca/65/54/ca655453eb79fe8db19601dfcf53ed95--vectors-calendar.jpg" style="width:50px;"/></span>');
