$(document).ready(function(){
	...
	*/
	...
	week = Number(pe.split("W")[1])+1;
	pe = year+"W"+week;
	update(pe);
	
	////////////////////////////////////////////////////////////
	//var year = reportDate.getFullYear();
	//var month = reportDate.getMonth(); // 0 for january	
	//var day = reportDate.getDate();
	//var dayOfWeek = reportDate.getDay(); // 1 for sunday
	////////////////////////////////////////////////////////////
	...
	function update(p){
		...
		$("#period").html("Week "+week+ " of " + pe.split("W")[0]+" ["+dates[0]+" - "+dates[1]+"]");
