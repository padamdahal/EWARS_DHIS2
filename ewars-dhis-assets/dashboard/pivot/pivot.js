  ...
  callWithJQuery(function($) {
    ...
    aggregators = (function(tpl) {
      return {
        ...
        "---": tpl.listUnique(", "),
        "---": tpl.sumOverSum(usFmt),
        "---": tpl.sumOverSumBound80(true, usFmt),
        "---": tpl.sumOverSumBound80(false, usFmt),
        "---": tpl.fractionOf(tpl.sum(), "total", usFmtPct),
        "---": tpl.fractionOf(tpl.sum(), "row", usFmtPct),
        "---": tpl.fractionOf(tpl.sum(), "col", usFmtPct),
        "---": tpl.fractionOf(tpl.count(), "total", usFmtPct),
        "---": tpl.fractionOf(tpl.count(), "row", usFmtPct),
        "---": tpl.fractionOf(tpl.count(), "col", usFmtPct)
      };
    })(aggregatorTemplates);
    renderers = {
